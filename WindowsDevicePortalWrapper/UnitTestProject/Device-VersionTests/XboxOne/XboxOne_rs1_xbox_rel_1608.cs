...
namespace Microsoft.Tools.WindowsDevicePortal.Tests
{
    ...
    public class XboxOne_rs1_xbox_rel_1608 : BaseTests
    {
        ...
        public void GetXboxLiveUserListTest_XboxOne_1608()
        {
            ...
            Task<UserList> getUserTask = (TestHelpers.Portal as XboxDevicePortal).GetXboxLiveUsersAsync();
            getUserTask.Wait();
        ...
        public void GetXboxSettingsTest_XboxOne_1608()
        {
            ...
            Task<XboxSettingList> getSettingsTask = (TestHelpers.Portal as XboxDevicePortal).GetXboxSettingsAsync();
        ...
        public void XboxAppRegisterTest()
        {
            ...
            Task registerTask = (TestHelpers.Portal as XboxDevicePortal).RegisterApplicationAsync("SomeLooseFolder");
            registerTask.Wait();
        ...
        public void XboxAppUploadFolderTest()
        {
            ...
            Task uploadTask = (TestHelpers.Portal as XboxDevicePortal).UploadPackageFolderAsync("MockData\\XboxOne", "DestinationLooseFolder");
            uploadTask.Wait();
        ...
        public void UpdateXboxLiveUsersTest()
        {
            ...
            Task updateUsersTask = (TestHelpers.Portal as XboxDevicePortal).UpdateXboxLiveUsersAsync(users);
        ...
        public void GetSingleXboxSettingTest()
        {
            ...
            Task<XboxSetting> getSettingTask = (TestHelpers.Portal as XboxDevicePortal).GetXboxSettingAsync(settingName);
            getSettingTask.Wait();
        ...
        public void UpdateXboxSettingsTest()
        {
            ...
            Task<XboxSetting> updateSettingsTask = (TestHelpers.Portal as XboxDevicePortal).UpdateXboxSettingAsync(setting);
        ...
        public void XboxScreenshotTest()
        {
            ...
            Task<Stream> screenshotTask = (TestHelpers.Portal as XboxDevicePortal).TakeXboxScreenshotAsync();
            screenshotTask.Wait();
        ...
        public void EnableFiddlerTest()
        {
            ...
            Task fiddlerEnableTask = (TestHelpers.Portal as XboxDevicePortal).EnableFiddlerTracingAsync("localhost", "8888");
            ...
            Task fiddlerDisableTask = (TestHelpers.Portal as XboxDevicePortal).DisableFiddlerTracingAsync();
