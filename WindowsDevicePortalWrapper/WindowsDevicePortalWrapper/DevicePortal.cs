...
namespace Microsoft.Tools.WindowsDevicePortal
{
    ...
    public partial class DevicePortal
    {
            ...
            string requestBodyContentType = null)
        {
            ...
            {
                WebSocket<object> websocket = this.CreateWebSocket<object>(true);
        ...
        protected WebSocket<T> CreateWebSocket<T>(bool sendStreams = false) => this.WebSockets.Create<T>(this.deviceConnection, this.ServerCertificateValidation, sendStreams);
